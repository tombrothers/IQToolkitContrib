...
namespace IQToolkitCodeGenSchema {
    public class DatabaseProvider : IQToolkitCodeGenSchema.IDatabaseProvider {
        ...
        public IDatabase GetDatabase(DatabaseType type) {
            return this.Databases.Where(x => x.Type == type).FirstOrDefault();
        }
        ...
        private IEnumerable<IDatabase> GetDatabases() {
            ...
            yield return new Database("SqlServerCe.3.5", "System.Data.SqlServerCe.3.5", DatabaseType.SqlCe35, true);
            yield return new Database("SqlServerCe.4.0", "System.Data.SqlServerCe.4.0", DatabaseType.SqlCe40, true);
