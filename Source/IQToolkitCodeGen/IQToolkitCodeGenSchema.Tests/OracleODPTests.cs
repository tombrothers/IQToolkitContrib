...
namespace IQToolkitCodeGenSchema.Tests {
    [TestClass]
    public class OracleODPTests : TestBase {
        #region Type
        ...
        public void OracleSchemaProviderTests_GetSchemaNoPluralizationTest() {
            ...
            Assert.AreNotEqual(Resources.OracleODPSchema, actual);
            Assert.AreNotEqual(Resources.OracleODPSchemaExcludeViews, actual);
            Assert.AreEqual(Resources.OracleODPSchemaNoPluralization, actual);
        }
        ...
        public void OracleSchemaProviderTests_GetSchemaExcludeViewsTest() {
            ...
            Assert.AreNotEqual(Resources.OracleODPSchema, actual);
            Assert.AreEqual(Resources.OracleODPSchemaExcludeViews, actual);
            Assert.AreNotEqual(Resources.OracleODPSchemaNoPluralization, actual);
        }
        ...
        public void OracleSchemaProviderTests_GetSchemaTest() {
            ...
            Assert.AreEqual(Resources.OracleODPSchema, actual);
            Assert.AreNotEqual(Resources.OracleODPSchemaExcludeViews, actual);
            Assert.AreNotEqual(Resources.OracleODPSchemaNoPluralization, actual);
        }
